...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if (    this.getId() != st.getId() ||
                this.getFirstName() != st.getFirstName() ||
                this.getLastName() != st.getLastName() ||
                this.getAverageGrade() != st.getAverageGrade()
                )
            return false;
    ...
    @Override
    public int hashCode() {
        int c1 = firstName.hashCode();
        int c2 = lastName.hashCode();
        int c3 = id.hashCode();
        int c4 = averageGrade.hashCode();
        int c = c1 + c2 + c3 + c4;
        return c;
